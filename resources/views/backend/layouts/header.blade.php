...
<body id="page-top">
    <div id="wrapper">
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item {{ Request::is('admin/contact-active', 'admin/contact-inactive') ? 'active':''}}">
                ...
                <div id="collapseContact" class="collapse" aria-labelledby="contact" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{url('/admin/contact-active')}}">Active Enquiries</a>
                        <a class="collapse-item" href="{{url('/admin/contact-inactive')}}">In Active Enquiries</a>
                    </div>
                </div>
            </li>
